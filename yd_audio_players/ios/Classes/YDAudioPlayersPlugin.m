#import "YDAudioPlayersPlugin.h"
#import <yd_audio_players/yd_audio_players-Swift.h>
#import <UIKit/UIKit.h>
#import <AVKit/AVKit.h>
#import <AVFoundation/AVFoundation.h>

static NSString *const CHANNEL_NAME = @"Netease-YD/audioplayers";
NSString *const AudioplayersPluginStop = @"AudioplayersPluginStop";


static NSMutableDictionary * players;

@interface YDAudioPlayersPlugin()
...
@implementation YDAudioPlayersPlugin {
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    ...
    YDAudioPlayersPlugin* instance = [[YDAudioPlayersPlugin alloc] init];
